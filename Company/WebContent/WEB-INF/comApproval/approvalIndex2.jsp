...
<%
	...
	String report_approval_no			= request.getParameter("report_approval_no").toString();
	String emp_no						= request.getParameter("emp_no").toString();
	String emp_name						= request.getParameter("emp_name").toString();
	String jikup						= request.getParameter("jikup").toString();
	String section						= request.getParameter("section").toString();
	String approval_title				= request.getParameter("approval_title").toString();
    String approval_text				= request.getParameter("approval_text").toString();
    String approval_level				= request.getParameter("approval_level").toString();
    String approval_reason				= request.getParameter("approval_reason").toString();
    String approval_use					= request.getParameter("approval_use").toString();
    String approval_expense				= request.getParameter("approval_expense").toString();
    String approval_cash				= request.getParameter("approval_cash").toString();
%>
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#report_approval_no"  ).val(report_approval_no);
		$("#emp_no").val(emp_no);
		$("#emp_name").val(emp_name);
		$("#jikup").textbox('setValue',jikup);
		$("#section").val(section);
		$("#approval_title").val(approval_title);
		$("#approval_text").val(approval_text);
		$("#approval_level").val(approval_level);
		$("#approval_reason").val(approval_reason);
		$("#approval_use").val(approval_use);
		$("#approval_expense").val(approval_expense);
		$("#approval_cash").val(approval_cash);
	});
...
<table border="0" cellpadding="0" cellspacing="0" style="margin: auto auto auto 4.2pt; width: 723px; height: 769px; border-collapse: collapse;">
   <tbody>
      ...
      <tr style="height: 27px;">
         ...
         <input class="easyui-text" type="text" id="jikup" name="jikup" style="width:98%;height:99%; text-align:center; font-size:1.5em;">
